...
export default async function EditTenderPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const initial: TenderFormFields = {
    ...
    reference_letters_required: tender.reference_letters_required,
    reference_letters_note: tender.reference_letters_note,
    reference_letters_within_years: tender.reference_letters_within_years,
    reference_letters_min_value: tender.reference_letters_min_value,
