...
export const NAV_ITEMS = [
  ...
  { href: "/reference-letters", label: "Reference Letters", icon: FileCheck2 },
  ...
  return (
    <>
      ...
      <div className="space-y-0.5 border-t border-sidebar-border px-3 py-3">
        {/* Only admins can do anything here. Shown to everybody, the link led
            to a page whose entire content was a sentence saying so. */}
        {isAdmin && (
          <Link
            href="/settings/users"
            onClick={onNavigate}
